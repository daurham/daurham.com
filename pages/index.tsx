      ...
      <main className=" bg-white px-10 md:px-20 lg:px-40 dark:bg-slate-900">
        <section className=" min-h-screen">
            ...
            <ul className=" flex items-center">
              <li>
                <BsFillMoonStarsFill
                  ...
                  className="text-black cursor-pointer text-2xl dark:text-moonl"
                />
              </li>
              <li>
                <a
          ...
          <div className=" text-center py-10">
            ...
            <p className="text-md py5 leading-8 text-slate-700 md:text-xl max-w-md mx-auto dark:text-slate-600">
